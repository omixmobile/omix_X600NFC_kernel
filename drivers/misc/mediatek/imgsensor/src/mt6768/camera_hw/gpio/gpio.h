...
// Antaiui <AI_BSP_CAM> <xieht> <2021-01-13> add mipi switch ldo gpio begin
#ifdef MIPI_SWITCH
enum GPIO_CTRL_STATE_SWITCH {
	...
	GPIO_CTRL_STATE_MIPI_SWITCH_LDO_H,
	GPIO_CTRL_STATE_MIPI_SWITCH_LDO_L,
	GPIO_CTRL_STATE_MAX_NUM_SWITCH,
};
#endif
// Antaiui <AI_BSP_CAM> <xieht> <2021-01-13> add mipi switch ldo gpio end
