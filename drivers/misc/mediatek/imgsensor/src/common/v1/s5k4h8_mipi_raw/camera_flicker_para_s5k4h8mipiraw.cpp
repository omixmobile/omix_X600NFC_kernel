...
#include "camera_AE_PLineTable_s5k4h8mipiraw.h"
#include "camera_info_s5k4h8mipiraw.h"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {918, 506, 945, -444};
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1622;
...
static void get_flicker_para_by_Capture_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1252, 371, 693, -364};
    FLICKER_CUST_STATISTICS EV60_L50 = {1493, 391, 1032, -439};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Capture_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1200, 387, 723, -375};
    FLICKER_CUST_STATISTICS EV60_L50 = {1431, 408, 1077, -450};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video1_Bin1(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {312, 1489, 2782, -720};
    FLICKER_CUST_STATISTICS EV60_L50 = {372, 1569, 4142, -794};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1414;
    para->flickerSearchRange = 8;
    para->minPastFrames = 3;
    para->maxPastFrames = 7;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Video1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {269, 1726, 3224, -758};
    FLICKER_CUST_STATISTICS EV60_L50 = {321, 1818, 4800, -832};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1674;
...
static void get_flicker_para_by_Video2_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {337, 1379, 2577, -700};
    FLICKER_CUST_STATISTICS EV60_L50 = {402, 1453, 3835, -775};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
...
static void get_flicker_para_by_Video2_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {445, 1043, 1949, -629};
    FLICKER_CUST_STATISTICS EV60_L50 = {531, 1099, 2902, -703};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1652;
    para->flickerSearchRange = 4;
    para->minPastFrames = 3;
    para->maxPastFrames = 7;
    para->EV50_L50 = EV50_L50;
