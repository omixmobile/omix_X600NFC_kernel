...
//column_length = 1175
//
#define LOG_TAG "gc02m1micromipiraw"
...
#include "camera_AE_PLineTable_gc02m1micromipiraw.h"
#include "camera_info_gc02m1micromipiraw.h"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    para->flickerGradThreshold = 1605;
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 2237;
