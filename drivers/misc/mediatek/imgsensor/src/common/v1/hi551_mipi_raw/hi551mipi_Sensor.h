...
// Antaiui <AI_BSP_CAM> <xieht> <2022-03-01> i2c multi write begin
extern int iBurstWriteReg(u8 *pData, u32 bytes, u16 i2cId);
extern int iBurstWriteReg_multi(u8 *pData, u32 bytes, u16 i2cId, u16 transfer_length, u16 timing);
// Antaiui <AI_BSP_CAM> <xieht> <2022-03-01> i2c multi write end

#ifdef CONFIG_BIRD_CAMERA_COVER_SUPPORT
extern int iReadRegI2C_main(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
extern int iWriteRegI2C_main(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId);
extern int iReadRegI2C_sub(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
extern int iWriteRegI2C_sub(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId);
extern int iReadRegI2C_smain(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16 a_sizeRecvData, u16 i2cId);
extern int iWriteRegI2C_smain(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId);
#endif
