...
//column_length = 1475
//
#define LOG_TAG "s5kgm1stmipiraw"
...
#include "camera_AE_PLineTable_s5kgm1stmipiraw.h"
#include "camera_info_s5kgm1stmipiraw.h"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1256, 465, 1227, -483};
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1504;
...
static void get_flicker_para_by_Video1_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {292, 1592, 2975, -737};
    FLICKER_CUST_STATISTICS EV60_L50 = {348, 1677, 4428, -812};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1330;
    para->flickerSearchRange = 24;
    para->minPastFrames = 3;
    para->maxPastFrames = 7;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Video1_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {275, 1688, 3153, -752};
    FLICKER_CUST_STATISTICS EV60_L50 = {328, 1778, 4694, -826};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
